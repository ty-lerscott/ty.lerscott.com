...
VALUES
  (
    ...
    '',
    33,
    'http://watercoo.lerscott.local/?p=47',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '',
    33,
    'http://watercoo.lerscott.local/?p=48',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '',
    0,
    'http://watercoo.lerscott.local/?p=49',
    0,
    'post',
    '',
    0
...
VALUES
  (
    ...
    '',
    49,
    'http://watercoo.lerscott.local/?p=50',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '',
    49,
    'http://watercoo.lerscott.local/?p=51',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '',
    41,
    'http://watercoo.lerscott.local/wp-content/uploads/2021/04/CleanShot-2021-04-29-at-13.05.51.png',
    0,
    'attachment',
    'image/png',
    0
...
VALUES
  (
    ...
    '',
    41,
    'http://watercoo.lerscott.local/wp-content/uploads/2021/04/image.png',
    0,
    'attachment',
    'image/png',
    0
...
VALUES
  (
    ...
    '',
    41,
    'http://watercoo.lerscott.local/wp-content/uploads/2021/04/image-1.png',
    0,
    'attachment',
    'image/png',
    0
...
VALUES
  (
    ...
    '2021-04-29 20:13:44',
    '2021-04-29 20:13:44',
    '<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>If when reading through a test file, you don\'t come away with more knowledge about the unit of code under question, that test is a failure. Maybe take the time to remove the noise and make some sense of the situation.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:heading -->\n<h2>What to test when your testing</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>A question I get  a lot from developers on my team at work is \"Well what should I be testing?\" or \"Should I test this or is that not important?\", and I still struggle with that question. Because, like all things engineering related.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It depends.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>My usually rules of thumb that work best for me are:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:list {\"ordered\":true} -->\n<ol><li>If it\'s a module: test all exports</li><li>If it\'s a simple react component: Test all UI static states (error render/expected render/pending render) and all interactions of the component</li><li>If the component inherits properties from a parent, mock those injections because you should only be testing the explicit functionality of the unit of code under examination, you should not imply the functionality that the component inherits. The parent should be testing that it can pass the functionality properly and that when passed it works as expected, not the child.</li></ol>\n<!-- /wp:list -->\n\n<!-- wp:heading -->\n<h2>Rules in the wild</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>I\'ll take you through an example from a test I had to familiarize myself with recently at work. Below is a simple enough test file that I think I can explain well enough.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":52,\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/CleanShot-2021-04-29-at-13.05.51.png\" alt=\"\" class=\"wp-image-52\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:list -->\n<ul id=\"block-cb9aede0-2735-4cbf-bb7e-94ee1a4e2572\"><li>Lines 1-4 are imports though line 4 is some sort of mockComponent function thing. sure.</li><li>Line 6 is mocking App which is a curried function that returns something now...I\'m assuming it\'s a JSX element that returns a component with the display name as the argument</li><li>Line 7 mocking a node module to be some sort of function that does this weird destructuring and currying and then returns that same mock function thing but now with the name from this function called <code>chunkName</code></li><li>Line 11 is a custom reusable function that returns a shallowly rendered router that has merged default props with the parameters passed into the function itself</li><li>Line 22 describe the file (I suppose in a way)</li><li>Line 23 describes the state of something called <code>Validity</code></li><li>Lines 24, 30, 37, and 43 all are describing the test conditions</li><li>Lines 25-27, 31, 32, 40, and 49 all make those test assertions</li></ul>\n<!-- /wp:list -->\n\n<!-- wp:paragraph -->\n<p>On paper, that test reads ok. It\'s extremely verbose, but the idea is there for what it\'s trying to test. The file that this is testing against also has about 81% total coverage with this test, so one might think that\'s a good enough place to stop.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>But I\'m Tyler and I think that we can do better than that. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading {\"level\":3} -->\n<h3>Rule One: Test all exports</h3>\n<!-- /wp:heading -->\n\n<!-- wp:heading {\"level\":4} -->\n<h4>Problem 1: The test was not describing the component</h4>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>This is the actual component. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":53,\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/image-212x1024.png\" alt=\"\" class=\"wp-image-53\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:paragraph -->\n<p>As you will notice there are 4 main exports of this file <code>default</code>, <code>matchPathToRoute</code>, <code>isSearchPage</code>, and <code>isValidRoute</code>, but if you look back at the above test, there is not a single test that describes any of those functions and the tests that are they, are very wordy and are clearly talking about application level logic.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It is a problem when you write tests that do not reflect your actual codebase. Test become immediately fragile when they do not follow the pattern of the code under exam and as a developer, you should not have to worry about tests after you\'ve written them well. When I added a route to this component, I would have assumed that the test for this component would fail because I added a new path to the list so there should be two new things that cause failures from my point of view however, when I ran the tests, everything passed.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading {\"level\":3} -->\n<h3>Rule 2: Test all UI static states</h3>\n<!-- /wp:heading -->\n\n<!-- wp:heading {\"level\":4} -->\n<h4>Problem 2: This module has no UI so there should not be anything to test</h4>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>This module exports 3 functions and an array of routes, but you can see that it\'s importing enzyme\'s shallow mount function. But really that should not happen since nothing in this file itself is responsible for rendering anything. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It is often difficult to separate the concerns of what to test and when, but try to keep it focused to exactly what the file does, not in how it is used by others.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>Out with the old</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>So I trashed the test</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>And in with the new</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>And rewrote it to be super explicit</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":54,\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/image-1-332x1024.png\" alt=\"\" class=\"wp-image-54\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:paragraph -->\n<p>Now, the outer describe explicitly is the name of the file, and the inner describes are the functions that are exported by the file and the inner tests are each branch of each function so to ensure coverage.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>With this, test coverage was increased to 87.29% (not amazing, but that\'s an issue for another day). That increase was due entirely due to seeing that there was a branch test missing from the original code since the original code was making a lot of assumptions about the state of the application.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>This test leaves a rather large TODO, but the idea is there to present the future breakage when adding/deleting of a route in the application. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>Conclusion</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>Writing tests can be scary, but if you approach them as objectively as possible, keeping the goal of functionality in mind, things may make more sense.</p>\n<!-- /wp:paragraph -->',
    'Removing Test Complexity',
    '',
    'inherit',
    'closed',
    ...
    '',
    41,
    'http://watercoo.lerscott.local/?p=55',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '2021-04-29 20:27:59',
    '2021-04-29 20:27:59',
    '<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>If when reading through a test file, you don\'t come away with more knowledge about the unit of code under question, that test is a failure. Maybe take the time to remove the noise and make some sense of the situation.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:heading -->\n<h2>What to test when your testing</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>A question I get  a lot from developers on my team at work is \"Well what should I be testing?\" or \"Should I test this or is that not important?\", and I still struggle with that question. Because, like all things engineering related.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It depends.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>My usually rules of thumb that work best for me are:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:list {\"ordered\":true} -->\n<ol><li>If it\'s a module: test all exports</li><li>If it\'s a simple react component: Test all UI static states (error render/expected render/pending render) and all interactions of the component</li><li>If the component inherits properties from a parent, mock those injections because you should only be testing the explicit functionality of the unit of code under examination, you should not imply the functionality that the component inherits. The parent should be testing that it can pass the functionality properly and that when passed it works as expected, not the child.</li></ol>\n<!-- /wp:list -->\n\n<!-- wp:heading -->\n<h2>Rules in the wild</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>I\'ll take you through an example from a test I had to familiarize myself with recently at work. Below is a simple enough test file that I think I can explain well enough.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":52,\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/CleanShot-2021-04-29-at-13.05.51.png\" alt=\"\" class=\"wp-image-52\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:list -->\n<ul id=\"block-cb9aede0-2735-4cbf-bb7e-94ee1a4e2572\"><li>Lines 1-4 are imports though line 4 is some sort of mockComponent function thing. sure.</li><li>Line 6 is mocking App which is a curried function that returns something now...I\'m assuming it\'s a JSX element that returns a component with the display name as the argument</li><li>Line 7 mocking a node module to be some sort of function that does this weird destructuring and currying and then returns that same mock function thing but now with the name from this function called <code>chunkName</code></li><li>Line 11 is a custom reusable function that returns a shallowly rendered router that has merged default props with the parameters passed into the function itself</li><li>Line 22 describe the file (I suppose in a way)</li><li>Line 23 describes the state of something called <code>Validity</code></li><li>Lines 24, 30, 37, and 43 all are describing the test conditions</li><li>Lines 25-27, 31, 32, 40, and 49 all make those test assertions</li></ul>\n<!-- /wp:list -->\n\n<!-- wp:paragraph -->\n<p>On paper, that test reads ok. It\'s extremely verbose, but the idea is there for what it\'s trying to test. The file that this is testing against also has about 81% total coverage with this test, so one might think that\'s a good enough place to stop.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>But I\'m Tyler and I think that we can do better than that. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading {\"level\":3} -->\n<h3>Rule One: Test all exports</h3>\n<!-- /wp:heading -->\n\n<!-- wp:heading {\"level\":4} -->\n<h4>Problem 1: The test was not describing the component</h4>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>This is the actual component. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":53,\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/image-212x1024.png\" alt=\"\" class=\"wp-image-53\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:paragraph -->\n<p>As you will notice there are 4 main exports of this file <code>default</code>, <code>matchPathToRoute</code>, <code>isSearchPage</code>, and <code>isValidRoute</code>, but if you look back at the above test, there is not a single test that describes any of those functions and the tests that are they, are very wordy and are clearly talking about application level logic.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It is a problem when you write tests that do not reflect your actual codebase. Test become immediately fragile when they do not follow the pattern of the code under exam and as a developer, you should not have to worry about tests after you\'ve written them well. When I added a route to this component, I would have assumed that the test for this component would fail because I added a new path to the list so there should be two new things that cause failures from my point of view however, when I ran the tests, everything passed.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading {\"level\":3} -->\n<h3>Rule 2: Test all UI static states</h3>\n<!-- /wp:heading -->\n\n<!-- wp:heading {\"level\":4} -->\n<h4>Problem 2: This module has no UI so there should not be anything to test</h4>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>This module exports 3 functions and an array of routes, but you can see that it\'s importing enzyme\'s shallow mount function. But really that should not happen since nothing in this file itself is responsible for rendering anything. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>It is often difficult to separate the concerns of what to test and when, but try to keep it focused to exactly what the file does, not in how it is used by others.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>Out with the old</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>So I trashed the test</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>And in with the new</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>And rewrote it to be super explicit</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:image {\"id\":54,\"sizeSlug\":\"large\",\"linkDestination\":\"attachment\"} -->\n<figure class=\"wp-block-image size-large\"><a href=\"http://watercoo.lerscott.local/?attachment_id=54\"><img src=\"http://watercoo.lerscott.local/wp-content/uploads/2021/04/image-1-332x1024.png\" alt=\"\" class=\"wp-image-54\"/></a></figure>\n<!-- /wp:image -->\n\n<!-- wp:paragraph -->\n<p>Now, the outer describe explicitly is the name of the file, and the inner describes are the functions that are exported by the file and the inner tests are each branch of each function so to ensure coverage.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>With this, test coverage was increased to 87.29% (not amazing, but that\'s an issue for another day). That increase was due entirely due to seeing that there was a branch test missing from the original code since the original code was making a lot of assumptions about the state of the application.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>This test leaves a rather large TODO, but the idea is there to present the future breakage when adding/deleting of a route in the application. </p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2>Conclusion</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>Writing tests can be scary, but if you approach them as objectively as possible, keeping the goal of functionality in mind, things may make more sense.</p>\n<!-- /wp:paragraph -->',
    'Removing Test Complexity',
    '',
    'inherit',
    'closed',
    ...
    '',
    41,
    'http://watercoo.lerscott.local/?p=56',
    0,
    'revision',
    '',
    0
...
VALUES
  (
    ...
    '',
    41,
    'http://watercoo.lerscott.local/?p=58',
    0,
    'revision',
    '',
    0
